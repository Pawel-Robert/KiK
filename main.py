...
from q_network import QNetworkLarger
import numpy as np
from runner import Runner
from agent import Big_Agent_Explorator, Big_Agent
...
network = QNetworkLarger(width, height)
...
runner = Runner(Big_Agent_Explorator, network, 1, env, 100, 10, True, height, width)
...
network.model.save("model_maj_against_heuristic_3.h5")
...
agent = Big_Agent(network, height, width)
