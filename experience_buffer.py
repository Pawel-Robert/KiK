...
class ExperienceBuffer:
    ...
    def add_trajectory(self, trajectory):
        ...
        # state = trajectory[0], action = trajectory[1], q_value = trajectory[2], reward = trajectory[3], done = trajectory[4]
        ...
        # # we add additional last piece of the trajectory NIEPOTRZEBNE!
        # st = current[0]
        # st = st.flatten()
        # st_input = np.array([st])
        # ac = np.zeros(9)
